...
4. **Test Verification**:
    - Run all unit tests and all available end-to-end tests to verify no regressions.
    - Investigate and fix any failures even if they are not directly related to the changes made.
