...
export const makeComp = (uuid: string, id: string, subComponents: ComponentNode[] = []): ComponentNode => ({
  uuid, id, name: id, type: "component",
  actors: [], subComponents, useCaseDiagrams: [], interfaces: [],
})

export const makeNamedComp = (uuid: string, id: string, name: string, subComponents: ComponentNode[] = []): ComponentNode => ({
