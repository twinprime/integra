            ...
            switch (c.kind) {
                case 'functionRef': {
                    ...
                    if (target?.componentUuid && !messageLabelToUuid[mermaidLabel])
                        messageLabelToUuid[mermaidLabel] = target.componentUuid
                    if (target?.interfaceUuid && !messageLabelToInterfaceUuid[mermaidLabel])
                        messageLabelToInterfaceUuid[mermaidLabel] = target.interfaceUuid
                    messageLinks.push({
                        kind: 'functionRef',
                ...
                case 'useCaseRef': {
                    ...
                    const renderedLabel = escapeLabel(mermaidLabel)
                    if (ucUuid && !messageLabelToUuid[mermaidLabel])
                        messageLabelToUuid[mermaidLabel] = ucUuid
                    messageLinks.push({
                        kind: 'useCaseRef',
                        renderedLabel: mermaidLabel,
                        targetUuid: ucUuid,
                ...
                case 'seqDiagramRef': {
                    ...
                    const renderedLabel = escapeLabel(mermaidLabel)
                    if (seqUuid && !messageLabelToUuid[mermaidLabel])
                        messageLabelToUuid[mermaidLabel] = seqUuid
                    messageLinks.push({
                        kind: 'seqDiagramRef',
                        renderedLabel: mermaidLabel,
                        targetUuid: seqUuid,
