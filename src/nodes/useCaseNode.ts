...
export const getSiblingIdsInUseCase = (uc: UseCaseNode, uuid: string): string[] | null => {
...
export const useCaseHandler: NodeHandler = {
    ...
    upsertChild: (node, _uuid, updater) => {
        ...
        return {
            ...uc,
            sequenceDiagrams: uc.sequenceDiagrams.map((sd) => updater(sd) as SequenceDiagramNode),
        }
    },
