...
describe("resolveEffectiveInterfaceFunctions", () => {
  it("returns local functions for non-inherited interfaces", () => {
    ...
    const iface = { uuid: "iface-uuid", id: "IFace", name: "IFace", type: "rest" as const, functions: [fn] }
  ...
  it("returns parent functions for inherited interfaces", () => {
    ...
    const root = makeComponent({ uuid: "root-uuid", id: "root", interfaces: [parentIface], subComponents: [child] })
