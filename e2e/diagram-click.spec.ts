...
test.describe('sequence diagram entity clicks', () => {
    ...
    test('clicking function message label activates the corresponding interface tab', async ({
        page,
    }) => {
        await page
            .locator(diagram())
...
test.describe('spec editor function link navigation', () => {
    ...
    test('clicking a function link in the spec editor activates the corresponding interface tab', async ({
        page,
    }) => {
        const fnToken = page.locator('.cm-integra-fn').first()
        await expect(fnToken).toBeVisible()
...
test.describe('function ref label with \\n line break', () => {
    ...
    test('renders \\n in function ref label as a visual line break in the diagram', async ({
        page,
    }) => {
    ...
    test('clicking the multi-line label navigates to the interface owner', async ({ page }) => {
        ...
        const msgLabel = page
            .locator('[data-testid="diagram-svg-container"] text.messageText')
            .filter({ hasText: /Sign/ })
            .first()
...
test.describe('numbered suffix for same function on different receivers', () => {
    ...
    test('renders numbered suffixes for the same function on different receivers', async ({
        page,
    }) => {
        const svg = page.locator('[data-testid="diagram-svg-container"]')
...
test.describe('interface tab activation when target is not the first tab', () => {
    ...
    test('clicking function message label activates IAuth even when it is not the first tab', async ({
        page,
    }) => {
        await page
            .locator(diagram())
    ...
    test('clicking a function link in the spec editor activates IAuth even when it is not the first tab', async ({
        page,
    }) => {
        const fnToken = page.locator('.cm-integra-fn').first()
        await expect(fnToken).toBeVisible()
